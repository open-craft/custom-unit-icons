...
"""
custom-unit-icons documentation build configuration file.
...
#
# html_title = 'custom-unit-icons v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'This plugin allows customizing unit icons in Studio.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'custom_unit_icons'),
                os.path.join(root_path, 'custom_unit_icons/migrations')])
